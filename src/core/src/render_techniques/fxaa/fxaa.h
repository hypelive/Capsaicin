...
namespace Capsaicin
{
class FXAA final : public RenderTechnique
{
public:
    FXAA();
    ~FXAA() override;

    FXAA(FXAA const &other)                = delete;
    FXAA(FXAA &&other) noexcept            = delete;
    FXAA &operator=(FXAA const &other)     = delete;
    FXAA &operator=(FXAA &&other) noexcept = delete;
