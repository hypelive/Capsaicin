...
namespace Capsaicin
{
class SSAO final : public RenderTechnique
{
public:
    SSAO();
    ~SSAO() override;

    SSAO(SSAO const &other)                = delete;
    SSAO(SSAO &&other) noexcept            = delete;
    SSAO &operator=(SSAO const &other)     = delete;
...
private:
    ...
    GfxProgram m_blurProgram;
    GfxKernel  m_blurKernel;
};
} // namespace Capsaicin
