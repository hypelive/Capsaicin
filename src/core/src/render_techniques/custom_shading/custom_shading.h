...
namespace Capsaicin
{
class CustomShading final : public RenderTechnique
{
public:
    CustomShading();
    ~CustomShading() override;

    CustomShading(CustomShading const &other)          = delete;
    CustomShading(CustomShading &&other) noexcept      = delete;
    CustomShading &operator=(CustomShading const &other) = delete;
    CustomShading &operator=(CustomShading &&other) noexcept = delete;
...
private:
    ...
    GfxProgram m_shadingProgram;
    GfxKernel m_shadingKernel;
};
} // namespace Capsaicin
