...
namespace Capsaicin
{
class DepthCopy final : public RenderTechnique
{
public:
    DepthCopy();
    ~DepthCopy() override;

    DepthCopy(DepthCopy const &other)          = delete;
    DepthCopy(DepthCopy &&other) noexcept      = delete;
    DepthCopy &operator=(DepthCopy const &other) = delete;
    DepthCopy &operator=(DepthCopy &&other) noexcept = delete;
