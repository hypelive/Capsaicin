...
namespace Capsaicin
{
class CustomVisibilityBuffer final : public RenderTechnique
{
public:
    CustomVisibilityBuffer();
    ~CustomVisibilityBuffer() override;

    CustomVisibilityBuffer(CustomVisibilityBuffer const &other)          = delete;
    CustomVisibilityBuffer(CustomVisibilityBuffer &&other) noexcept      = delete;
    CustomVisibilityBuffer &operator=(CustomVisibilityBuffer const &other) = delete;
    CustomVisibilityBuffer &operator=(CustomVisibilityBuffer &&other) noexcept = delete;
...
private:
    ...
    GfxBuffer m_lights_count_buffer;
    GfxBuffer m_lights_buffer;
