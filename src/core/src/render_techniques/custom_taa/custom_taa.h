...
namespace Capsaicin
{
class CustomTAA final : public RenderTechnique
{
public:
    CustomTAA();
    ~CustomTAA() override;

    CustomTAA(CustomTAA const &other)                = delete;
    CustomTAA(CustomTAA &&other) noexcept            = delete;
    CustomTAA &operator=(CustomTAA const &other)     = delete;
    CustomTAA &operator=(CustomTAA &&other) noexcept = delete;
