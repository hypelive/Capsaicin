...
namespace Capsaicin
{
class CustomVisibilityToGBuffer final : public RenderTechnique
{
public:
    CustomVisibilityToGBuffer();
    ~CustomVisibilityToGBuffer() override;

    CustomVisibilityToGBuffer(CustomVisibilityToGBuffer const &other)          = delete;
    CustomVisibilityToGBuffer(CustomVisibilityToGBuffer &&other) noexcept      = delete;
    CustomVisibilityToGBuffer &operator=(CustomVisibilityToGBuffer const &other) = delete;
    CustomVisibilityToGBuffer &operator=(CustomVisibilityToGBuffer &&other) noexcept = delete;
