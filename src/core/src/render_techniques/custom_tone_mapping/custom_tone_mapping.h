...
namespace Capsaicin
{
class CustomToneMapping final : public RenderTechnique
{
public:
    CustomToneMapping();
    ~CustomToneMapping() override;

    CustomToneMapping(CustomToneMapping const &other)                = delete;
    CustomToneMapping(CustomToneMapping &&other) noexcept            = delete;
    CustomToneMapping &operator=(CustomToneMapping const &other)     = delete;
    CustomToneMapping &operator=(CustomToneMapping &&other) noexcept = delete;
